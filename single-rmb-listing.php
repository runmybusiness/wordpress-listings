            ...
            <?php if (! empty($img)): ?>
                <a href="<?php echo array_get($runmybusiness_data,
                    ...
                    <img class="run-my-business-photo" src="<?php echo array_get($runmybusiness_data,
                        'property.data.primaryPhoto.data.sizes.250_sq'); ?>" alt="<?php the_title(); ?>" class="aligncenter"/>
                </a>
            <?php else: ?>
        ...
        <div style="float: right; width: 75%">
            ...
            <table class="run-my-business-details">
                <tr>
                    ...
                    <td><?php echo getField($runmybusiness_data['property']['data'], 'address'); ?></td>
                </tr>
                <tr>
                    <td style="width: 30%;"><strong>Property Type: </strong></td>
                    <td><?php echo get_post_meta($post->ID, 'property_type', true); ?></td>
                </tr>
                <tr>
                    <td><strong>Monthly Rent: </strong></td>
                    <td><?php echo getField($runmybusiness_data, 'price'); ?></td>
                </tr>
                <tr>
                    <td><strong>Square footage: </strong></td>
                    <td><?php echo getField($runmybusiness_data['property']['data'], 'square_foot'); ?></td>
                </tr>
                <tr>
                    <td><strong>Bedrooms: </strong></td>
                    <td><?php echo getField($runmybusiness_data['property']['data'], 'bedrooms'); ?></td>
                </tr>
                <tr>
                    <td><strong>Bathrooms: </strong></td>
                    <td><?php echo getField($runmybusiness_data['property']['data'], 'bathrooms'); ?></td>
                </tr>
                <tr>
                    <td><strong>Transaction type: </strong></td>
                    <td><?php echo get_post_meta($post->ID, 'transaction_type', true); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo getField($runmybusiness_data, 'salient_points'); ?></td>
                </tr>
            </table>
                ...
                <script>
                    ...
                    function initMap() {
                        map = new google.maps.Map(document.getElementById('single-map'), {
                            center: {
                                lat: <?php echo array_get_from_field_array($runmybusiness_data['property']['data'], 'address', 'payload.geo.lat') ?>,
                                lng: <?php echo array_get_from_field_array($runmybusiness_data['property']['data'], 'address', 'payload.geo.lng') ?>
                            },
                            zoom: 13
                        });
            ...
            the_post_navigation([
                'prev_text' => '<span class="meta-nav-prev" aria-hidden="true">' . __('', 'twentyfifteen') . '</span> ' .
                    '<span style="float: left; padding: 20px;"><span class="screen-reader-text" style="float: left">' . __('Previous Listing:',
                        'twentyfifteen') . '</span></span> ' .
                ...
                'next_text' => '<span class="meta-nav-next" aria-hidden="true">' . __('', 'twentyfifteen') . '</span> ' .
                    '<span style="float: right; padding: 20px;"><span class="screen-reader-text">' . __('Next Listing:',
                        'twentyfifteen') . '</span> ' .
